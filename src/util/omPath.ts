 ...
 * numeric array indices, returning `undefined` for any missing segment. Ported verbatim from
 * duet-tool-align (itself mirroring Flexible-Layouts' widget helper). Pure and dependency-free.
 */
